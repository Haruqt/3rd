...
const PRIZES = [
  { id: 'baby-photo', name: "Baby's Photo", image: 'images/baby-photo.jpg', message: 'Look at my pretty baby.', rarity: 'common' },
  { id: 'lovebirds', name: 'Our Love Birds', image: 'images/lovebirds.jpg', message: 'Just two love birds being us.', rarity: 'common' },
  { id: 'babycake', name: 'Babycake', image: 'images/babycake.jpg', message: 'Still my babycake crush.', rarity: 'common' },
  { id: 'hug', name: 'Hug', image: 'images/hug.jpg', message: 'One hug from me. No expiration.', rarity: 'common' },
  { id: 'kiss', name: 'Kiss', image: 'images/kiss.jpg', message: 'Okay baby, this one is yours.', rarity: 'uncommon' },
  { id: 'smile', name: 'Your Smile', image: 'images/smile.jpg', message: 'One of my favorite things about you.', rarity: 'uncommon' },
  { id: 'funny', name: 'Funny Prize', image: 'images/funny.jpg', message: 'HAHAHA you thought you were getting something serious.', rarity: 'common' },
  { id: 'selos', name: 'Selos', image: 'images/selos.jpg', message: 'Warning: my selos is still under development.', rarity: 'uncommon' },
  { id: 'clingy', name: 'Clingy', image: 'images/clingy.jpg', message: 'Congratulations. You unlocked my clingy side.', rarity: 'uncommon' },
  { id: 'coupon', name: 'Love Coupon', image: 'images/coupon.jpg', message: 'One free hug from me. Cannot be exchanged for cash.', rarity: 'rare' },
  { id: 'secret', name: 'Secret', image: 'images/secret.jpg', message: 'Not the final prize. Keep trying, baby.', rarity: 'rare' },
  { id: 'random-baby', name: 'Random Baby Pic', image: 'images/random-baby.jpg', message: 'Random baby pic unlocked. Still pretty and cute as always.', rarity: 'uncommon' },
...
function updateAttemptsDisplay() {
  attemptsCountEl.textContent = Math.max(0, state.attempts);
}
...
function renderCapsules() {
  stageEl.innerHTML = '';
  PRIZES.filter((p) => !p.wonAlready).forEach((p) => {
...
function tryGrabCapsule(clawX) {
  const candidates = PRIZES.filter((p) => !p.wonAlready);
  let best = null;
...
async function performDrop() {
  if (state.isDropping || state.attempts <= 0) return;
...
$('#btnPlayAgainFromOut').addEventListener('click', () => {
  playSfx('uiClick', 0.5);
...
function resetGame() {
  state.attempts = GAME_CONFIG.maxAttempts;
  updateAttemptsDisplay();
  generateLayout();
  renderCapsules();
  state.clawX = 50;
